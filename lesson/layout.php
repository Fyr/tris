...
?>
		...
		<div id="lesson-container" class="container">
			<? include(BASE_DIR.'view/view_content.php')?>
		</div>
			...
			<div id="tab-4" class="tab search-panel">
				...
				<div class="tab-scroll">
					<div class="tab-holder">
						...
						<? include(BASE_DIR.'view/view_search.php')?>
					</div>
				</div>
			</div>
			<div id="tab-5" class="tab comments-panel">
				...
				<div class="tab-scroll">
					<div class="tab-holder">
						...
						<? include(BASE_DIR.'view/view_postform.php')?>
					</div>
				</div>
			</div>
			<div id="tab-6" class="tab notes-panel">
				...
				<div class="tab-scroll">
					<div class="tab-holder">
						...
						<? include(BASE_DIR.'view/view_notesform.php')?>
					</div>
				</div>
			</div>
