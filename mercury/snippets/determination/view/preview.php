...
<div align="<?=@$_POST['align']?>" style="<?=$style?>"><img src="<?=$assetsPath?>img/warning.png" alt="" /> <span <? if ($edit) {?>contenteditable="true" onchange="onChangeEditable(this, 'editable')"<? } ?>><?=@$_POST['editable']?></span></div>
