<?
	$editable = (isset($_POST['editable'])) ? $_POST['editable'] : 'Текст врезки...';
	$title = (isset($_POST['title'])) ? $_POST['title'] : 'Текст заголовка...';
...
?>
			...
			<br />
			<label class="string optional control-label inline" for="image_height_perc" style="width: 66px">Заголовок</label>
    		<input type="text" class="string optional" id="custom-editable2" name="title" value="<?=$title?>" style="width: 470px" />
    		<br />
			<label class="string optional control-label inline" for="image_height_perc" style="width: 66px">Текст</label>
